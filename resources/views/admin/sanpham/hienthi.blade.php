                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-sm">
                                                    <span class="tb-product">
                                                        <img src="{{asset('uploads/img/'.$sanpham->sp_hinh) }}" alt=""
                                                            class="thumb">
                                                    </span>
                                                </div>
                                                <div class="nk-tb-col tb-col-sm">
                                                ...
                                                <div class="nk-tb-col tb-col-sm">
                                                    <span class="tb-product">
                                                        @if ($sanpham->sp_giamgia > 0)
                                                            ...
                                                            <span>-</span>
                                                            <span class="title">{{ number_format($sanpham->sp_giaban-((($sanpham->sp_giamgia)*($sanpham->sp_giaban))/100)) }}
                                                            </span>
                                                        @else
                                                ...
                                                <div class="nk-tb-col">
                                                    @if ($sanpham->sp_tinhtrang == 0)
                                                        ...
                                                        <span
                                                            class="badge badge-sm badge-dot has-bg badge-warning d-none d-mb-inline-flex">Ngừng hoạt động</span>
                                                    @else
                                                        <span class="dot bg-success d-mb-none"></span>
                                                        <span class="badge badge-sm badge-dot has-bg badge-success d-none d-mb-inline-flex">Đang hoạt động</span>
                                                    @endif
                                                </div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1 my-n1">
                                                        <li class="mr-n1">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a
                                                                                href="{{ route('admin.sanpham.sua', ['id' => $sanpham->sp_ma]) }}"><em
                                                                                    class="icon ni ni-edit"></em><span>Cập nhật SP</span></a>
                                                                        </li>
                                                                        <li><a href="{{ route('admin.sanpham.suakm', ['id' => $sanpham->sp_ma]) }}"><em
                                                                                    class="icon ni ni-gift"></em><span>Cập nhật KM</span></a>
                                                                        </li>
                                                                        <li><a href="{{ route('admin.sanpham.suacombo', ['id' => $sanpham->sp_ma]) }}"><em
                                                                            class="icon ni ni-gift"></em><span>Cập nhật COMBO</span></a>
                                                                        </li>
                                                                        <li><a href="{{ route('admin.sanpham.xoa', ['id' => $sanpham->sp_ma]) }}"><em
