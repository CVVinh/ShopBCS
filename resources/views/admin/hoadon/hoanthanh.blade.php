                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Danh sách hóa đơn hoàn tất</h3>
                            @if ($errors->any())
                                            ...
                                            <ul class="nk-tb-actions gx-1 my-n1">
                                                <li class="mr-n1">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{route('admin.hoadon.cthoadonht',['id'=>$hoadon->hd_ma])}}"><em class="icon ni ni-edit"></em><span>Xem chi tiết</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
