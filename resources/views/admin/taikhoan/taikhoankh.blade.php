                        ...
                        <div class="card-inner-group">
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-sm">
                                            <span class="tb-product">
                                                ...
                                                <span class="title">{{$khachhang->ten}}</span>
                                            </span>
                                        </div>
                                        <div class="nk-tb-col tb-col-sm">
                                            <span class="tb-product">
                                                {{-- <img src="./images/product/a.png" alt="" class="thumb"> --}}
                                                <span class="title">{{$khachhang->sdt != null ? $khachhang->sdt : $khachhang->email}}</span>
                                            </span>
                                        </div>
                                        @php
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <button id={{$khachhang->kh_ma.'khoa'}} name="khoa" onclick="khoa(this);" value="{{$khachhang->kh_ma}}" >Khóa</button>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <button id={{$khachhang->kh_ma.'mokhoa'}} name="mokhoa" onclick="khoa(this);" value="{{$khachhang->kh_ma}}">Mở khóa</button>
                                        </div>
                                    </div><!-- .nk-tb-item -->
                                    @endforeach
                                </div><!-- .nk-tb-list -->
                            ...
                            <div class="card-inner">
                                <div class="nk-block-between-md g-3">
                                    ...
                                    <div class="g">
                                    Hiển thị từ {{$khachhangs->firstItem()}} đến {{$khachhangs->lastItem()}} của {{$khachhangs->total()}} sản phẩm
                                    </div>
                                </div><!-- .nk-block-between -->
                            </div>
                        </div>
