...
@section('content')
    <div class="nk-content ">
        <form action="{{ route('admin.phieunhap.sua',['id'=>$phieunhap->pn_ma]) }}" method="post" enctype="multipart/form-data" class="formLoaiSanPham">
            @csrf
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">Cập nhật phiếu nhập</h5>
                    <h6 class="nk-block-title">MS: {{$phieunhap->pn_ma}}</h6>
                    @if ($errors->any())
            ...
            <div class="nk-block">
                ...
                @foreach($phieunhap->sanphams as $sanpham1)
                    <div class="row g-3"  id="sanpham_ten{{$sanpham->sp_ma}}">
                        <div class="col-6">
                            <div class="form-group">
                                <div class="form-control-wrap">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input class="form-control" type="number" placeholder="Số lượng"   id="sanpham_ma{{$sanpham1->sp_ma}}"  name="soluong[{{$sanpham1->sp_ma}}]" value=""></input>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input class="form-control" type="number" placeholder="Giá nhập"   id="sanpham_ma{{$sanpham1->sp_ma}}"  name="gianhap[{{$sanpham1->sp_ma}}]" value=""></input>
                                </div>
                            </div>
                        </div>
                    </div>
