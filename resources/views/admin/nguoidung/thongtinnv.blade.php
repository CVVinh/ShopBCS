...
<div class="nk-content ">
    <form action="{{route('admin.nguoidung.sua',['id'=>$nhanvien->nv_ma])}}" method="post"
    enctype="multipart/form-data" class="formLoaiSanPham">
    @csrf
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">Cập nhật thông tin nhân viên - MS {{$nhanvien->nv_ma}}</h5>
                @if ($errors->any())
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <div id="hinh1">
                                <img  
                                src="{{asset('uploads/img/'.$nhanvien->hinh) }}" 
